          ...
          <tbody className="divide-y divide-stone-200">
            {filteredData.map(product => (
              ...
              >
                ...
                <td className="px-2 py-2 text-xs text-stone-800">
                  <div className="flex items-center gap-1">
                    <button className="mr-2 rounded-sm p-1 hover:bg-purple-100">
                      <FiEdit3 size={18} color={COLORS.purple} />
                    </button>
                    <button className="mr-2 rounded-sm p-1 hover:bg-pink-100">
                      <FiDelete size={18} color={COLORS.pink} />
                    </button>
                  </div>
                </td>
              </motion.tr>
